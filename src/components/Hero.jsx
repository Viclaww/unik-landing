...
const Hero = () => {
  return (
    <div className="flex relative sm:flex-col px-32 md:h-[80vh] sm:px-10 font-Monstserrat text-white h-[90vh] sm:h-[100vh] sm:justify-center justify-normal items-center ">
