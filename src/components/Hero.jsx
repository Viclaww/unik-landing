...
const Hero = () => {
  return (
    <div className="flex relative sm:mb-[10vh] sm:flex-col px-32 md:h-[80vh] sm:px-10 font-Monstserrat text-white h-[90vh] sm:h-[65vh] sm:justify-center justify-normal items-center ">
