...
const WhyEnroll = () => {
  return (
    <div className="flex font-Monstserrat items-center flex-wrap justify-between  w-full py-20 px-24 sm:px-2 md:mt-[10vh]  md:p-10 md: bg-[#D00FFC] md:flex-col sm:flex-col">
